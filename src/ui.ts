...
<div class="assist-controls"><button id="scoop-assist" aria-label="贴地铲装" aria-pressed="false" disabled>${icon("target", 16)} <strong>贴地铲装</strong><kbd id="grab-key" hidden>Space</kbd><span id="assist-state">关闭</span></button><small id="assist-hint">自动调整到装料姿态。</small></div>
